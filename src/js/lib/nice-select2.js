...
//   console.log('renderDropdown', this.renderButtons);
  ...
  let mobileTitleHtml = `<button class="nice-select-mobile-title">`;
  	mobileTitleHtml  += `<svg class="nice-select-icon"><use xlink:href="#arrow"></use></svg>`;
    mobileTitleHtml  += `<span class="nice-select-title">${this.placeholder}</span>`;
  ...
  var html = `<div class="${classes.join(" ")}" tabindex="${this.disabled ? null : 0}">`;
      ...
      html += `<div class="nice-select-dropdown">`;
		...
		html += `${this.config.titled ? mobileTitleHtml : ""}`;
